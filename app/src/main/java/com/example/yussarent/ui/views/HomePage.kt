        ...
        LazyVerticalGrid(
            ...
            item {
                Box(
                    ...
                    roomsData["available"]?.let { AvailableRoomsScreen(it,roomViewModel = null, navController) }
                }
            }
            item {
                Box(
                    ...
                    roomsData["occupied"]?.let { OccupiedRoomsScreen(it,roomViewModel = null, navController) }
                }
            }
            item {
                Box(
